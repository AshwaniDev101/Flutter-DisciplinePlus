...
import 'calorie_counter_page/add_edit_diet_food_dialog.dart';
import 'calorie_counter_page/food_manager.dart';
...
class CaloriesCounterPageBackup extends StatefulWidget {
  final DateTime pageDateTime;

  const CaloriesCounterPageBackup({super.key, required this.pageDateTime});

  @override
  State<CaloriesCounterPageBackup> createState() => _CaloriesCounterPageBackupState();
}

class _CaloriesCounterPageBackupState extends State<CaloriesCounterPageBackup> {
  String _searchQuery = '';
